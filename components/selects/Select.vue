...
<template>
    <div class="g-select-container">
        <div role="select" ref="gSelectHeaderRef" class="g-select-header" @click="changeDropdownState">
            ...
            <div :class="dropdownState ? 'g-header-arrow-box-active' : 'g-header-arrow-box'"><svg width="42" height="42"
        ...
        <div :class="{'g-select-dropdown': true, 'dropdown-on': dropdownState, 'dropdown-off': !dropdownState }"
            ref="dropdownRef">
